...
if len(sys.argv) == 3:
   ...
   for j in range ( len(listf)):
              ...
              if listcodec1[0]==(' ITU-T G.711 PCMA (8)\r\n\t'): 
                  ...
                  cmds = ['C:\\FFmpeg\\bin\\ffmpeg.exe', '-f', 'alaw', '-ar', '8000', '-i', 'output_raw.raw', 'output_wav.wav']
              ...
              #check if the codec used is G722
                  ...
                  #convert the raw file to a wav file using ffmpeg
                  cmds = ['C:\\FFmpeg\\bin\\ffmpeg.exe', '-f', 'g722', '-i', 'output_raw.raw', 'output_wav.wav']
                  subprocess.call(cmds)
              ...
              #check if the codec used is G726
                  ...
                  #convert the raw file to a wav file using ffmpeg
                  cmds = ['C:\\FFmpeg\\bin\\ffmpeg.exe', '-f', 'g726le',  '-i', 'output_raw.raw', 'output_wav.wav']
                  subprocess.call(cmds)
              ...
              #check if the codec used is G729
                  ...
                  #convert the raw file to a wav file using ffmpeg
                  cmds = ['C:\\FFmpeg\\bin\\ffmpeg.exe', '-f', 'g729', '-i', 'output_raw.raw', 'output_wav.wav']
                  subprocess.call(cmds)
              ...
              #check if the codec used is GSM
                  ...
                  #convert the raw file to a wav file using ffmpeg
                  cmds = ['C:\\FFmpeg\\bin\\ffmpeg.exe', '-f', 'gsm', '-i', 'output_raw.raw', 'output_wav.wav']
                  subprocess.call(cmds)
   ...
   # C:\Users\7NR_Operator_14\Downloads\WiresharkPortable64\App\Wireshark\tshark.exe